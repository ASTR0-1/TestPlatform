        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerOptions_Question_QuestionId",
            ...
            migrationBuilder.InsertData(
                table: "Tests",
                columns: new[] { "Id", "Description", "QuestionCount", "Title" },
                values: new object[,]
                {
                    { 1, "Description for test1", 4, "Test1" },
                    { 2, "Description for test2", 4, "Test2" }
                });

            migrationBuilder.InsertData(
                table: "Question",
                columns: new[] { "Id", "QuestionNumber", "QuestionText", "TestId" },
                values: new object[,]
                {
                    { 1, 1, "Question1", 1 },
                    { 2, 2, "Question2", 1 },
            ...
            migrationBuilder.InsertData(
                table: "UserTest",
                columns: new[] { "TestId", "UserId", "Answers", "FinishTime", "IsCompleted", "Rating" },
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 0 },
                    { 2, 2, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 0 }
                });

            migrationBuilder.InsertData(
                table: "AnswerOptions",
                columns: new[] { "Id", "IsCorrect", "OptionNumber", "OptionText", "QuestionId" },
                values: new object[,]
                {
                    { 1, true, 1, "OptionText1", 1 },
                    { 2, false, 2, "OptionText2", 1 },
                    { 3, false, 3, "OptionText3", 1 },
                    { 4, false, 4, "OptionText4", 1 },
                    { 5, false, 1, "OptionText1", 2 },
                    { 6, true, 2, "OptionText2", 2 },
                    { 7, false, 3, "OptionText3", 2 },
                    { 8, false, 4, "OptionText4", 2 },
                    { 9, false, 1, "OptionText1", 3 },
                    { 10, true, 2, "OptionText2", 3 },
                    { 11, false, 1, "OptionText1", 4 },
                    { 12, false, 2, "OptionText2", 4 },
                    { 13, true, 3, "OptionText3", 4 },
                    { 14, true, 1, "OptionText1", 5 },
                    { 15, false, 2, "OptionText2", 5 },
                    { 16, false, 3, "OptionText3", 5 },
                    { 17, false, 4, "OptionText4", 5 },
                    { 18, false, 1, "OptionText1", 6 },
                    { 19, true, 2, "OptionText2", 6 },
                    { 20, false, 3, "OptionText3", 6 },
                    { 21, false, 4, "OptionText4", 6 },
                    { 22, false, 1, "OptionText1", 7 },
                    { 23, true, 2, "OptionText2", 7 },
                    { 24, false, 1, "OptionText1", 8 },
                    { 25, false, 2, "OptionText2", 8 },
                    { 26, true, 3, "OptionText3", 8 }
                });
